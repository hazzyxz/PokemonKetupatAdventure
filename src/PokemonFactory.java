...
public class PokemonFactory {
    ...
    static {
        ...
        Pokemon oddish = new Pokemon("Oddish", 45, new String[] {"grass", "poison"}, 1, new String[] {"fighting", "water", "grass", "electric", "fairy"}, new String[] {"flying", "fire", "psychic", "ice"}, scratchMove, vineWimpMove);
