...
public class CeladonCity extends Screen {

    public CeladonCity(GamePanel gp, KeyHandler keyH) {
        super(gp, keyH, "/Backgrounds/celadon.jpg");
    ...
    public void update() {
        ...
        if (userInput.equals("/gym")) {
            GymLeader gymLeader = GymLeaderFactory.leaderErika();
